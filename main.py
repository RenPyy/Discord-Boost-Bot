...
async def stock(ctx: discord.ApplicationContext):
    ...
    embed = discord.Embed(title=f"Stock",
                          color=0x0084ff)
    embed.set_image(url="https://cdn.discordapp.com/attachments/1003187662045315173/1006825049048760360/deluxe.png")
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1003187662045315173/1006825049443029053/deluxepfp.png")
    ...
    if prefix + "stock" in message.content:
        ...
        if is_licensed(message.author.id):
            embed = discord.Embed(title=f"Your stock",
                                  color=0x0084ff)
            embed.set_image(
                url="https://cdn.discordapp.com/attachments/1003187662045315173/1006825049048760360/deluxe.png")
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/attachments/1003187662045315173/1006825049443029053/deluxepfp.png")
            embed.add_field(name="Your Available Boosts",
                            value=f"<@{message.author.id}> You have {len(open(f'{message.author.id}.txt', encoding='utf-8').read().splitlines()) * 2} available boosts.")
...
#|_______/  \______/  \______/  \______/    |__/         |_______/  \______/    |__/
 #                       ! brendan#0999 | discord.gg/bnservices
